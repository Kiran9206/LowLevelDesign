...
Review the original class: Take a closer look at the ImageEditingManager class and its methods. Understand how each editing module is handled and the interactions involved.

Create the facade class: Create a new class named ImageEditingFacade that implements the Facade pattern. This class will encapsulate the interactions with the image editing module, providing a simplified way to edit images.
...
Test your implementation: Test cases have been provided for you to verify your implementation. Run the test cases to ensure that your facade class works correctly and provides the expected image editing functionality.
'''